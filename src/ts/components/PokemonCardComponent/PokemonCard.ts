  ...
  renderHtml(): void {
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        ...
        <a href="../../pokemonDetails.html" class="card-icon zoom zoom:hoover"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
